...
int main() {
  ...
  double ref_vel = 0; //mph, max should be 49.5
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
			...
			// Interpolate these later with a spline and fill in with more points to control speed.
			vector<double> ptsx;
			vector<double> ptsy;
			...
			// Start with all of the previous path points from last time - the anchor points
